========================================================================
    KONSOLENANWENDUNG: ConsoleSapiTest-Projektübersicht
========================================================================

Diese ConsoleSapiTest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ConsoleSapiTest-Anwendung besteht.


ConsoleSapiTest.vcxproj
...
ConsoleSapiTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ConsoleSapiTest.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
